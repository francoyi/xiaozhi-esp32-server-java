 ...
 */
@Component
public class QwenModelProvider implements ChatModelProvider {
    
    private static final Logger logger = LoggerFactory.getLogger(QwenModelProvider.class);
    ...
    public ChatModel createChatModel(SysConfig config, SysRole role) {
        ...
        logger.info("Created Qwen ChatModel: model={}, endpoint={}", model, endpoint);
        return chatModel;
    }
}
